...
- 🟢 [SOV] [LLM Tech](https://llmtech.eu/) (PL) - OpenAI-compatible inference for Qwen3.8-27B (262K context) on EU-owned infrastructure (German edge, Finnish GPU datacenter). Zero data retention, public live status page with measured TTFT and throughput.
